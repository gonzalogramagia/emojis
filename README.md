...
- **Create**: Click the wrench icon (bottom right) to open the configuration modal, where you can add brand new custom emojis.
  - _Note_: All your custom creations and edits are **saved locally in your browser (LocalStorage)**. They will persist on this device but won't sync across different browsers or devices.
